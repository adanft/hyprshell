...
Rectangle {
    ...
    border.color: selected ? theme.screenshotToolAccentColor : theme.appLauncherCardHoverBorderColor
    ...
    Column {
        ...
        Shared.AppText {
            ...
            text: action.icon
            color: action.selected ? action.theme.screenshotToolAccentColor : action.theme.screenshotToolActionHoverColor
        ...
        Shared.AppText {
            width: parent.width
            text: action.title
            color: action.theme.screenshotToolTextColor
