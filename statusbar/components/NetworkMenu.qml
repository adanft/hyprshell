...
Item {
    ...
    readonly property bool activeDetail: expandedNetworkSection === "output" || expandedNetworkSection === "microphone" || expandedNetworkSection === "ethernet" || expandedNetworkSection === "wifi" || expandedNetworkSection === "bluetooth"
    readonly property real uptimeSeconds: networkController.uptimeSeconds
    readonly property var availableWifiNetworks: Networking.wifiHardwareEnabled && Networking.wifiEnabled && !wifiActivationPending && services.network.wifiDevice ? NetworkMenuLogic.sortedWifiNetworks(services.network.wifiDevice.networks?.values ?? []) : []
    ...
    readonly property string outputIcon: root.outputIconKind === "unavailable" ? root.icons.volumeUnavailable : (root.outputIconKind === "muted" ? root.icons.volumeMuted : (root.outputIconKind === "low" ? root.icons.volumeLow : (root.outputIconKind === "medium" ? root.icons.volumeMedium : root.icons.volumeHigh)))
    ...
    function clampDetailContentY() {
        detailFlickable.contentY = NetworkMenuLogic.clampDetailContentY(root.activeDetail, detailFlickable.contentY, detailFlickable.contentHeight, detailFlickable.height)
    }
    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            height: NetworkMenuLogic.menuCenterHeight(menuWindow.height, root.theme.spacing.space16, 360, root.theme.spacing.space24, fixedShell.implicitHeight, root.theme.spacing.space8, root.activeDetail, detailContent.implicitHeight, root.theme.sizing.statusBarNetworkQuickControlHeight)
            ...
            Column {
                ...
                Column {
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            NetworkControlCard {
                                ...
                                colors: root.colors
                                theme: root.theme
                                icon: root.services.network.lanUp ? root.icons.ethernet : root.icons.ethernetDisconnected
                                title: "Ethernet"
                                subtitle: root.services.network.lanUp ? "Connected" : (root.services.network.lanDevice?.hasLink ? "Disconnected" : "Cable unplugged")
                                active: root.services.network.lanUp
                                available: root.services.network.lanDevice?.network !== null && root.services.network.lanDevice?.network !== undefined
                            ...
                            NetworkControlCard {
                                ...
                                colors: root.colors
                                theme: root.theme
                                icon: root.services.network.wifiUp ? root.icons.wifiConnected : (Networking.wifiEnabled ? root.icons.wifiEnabled : root.icons.wifiDisconnected)
                                title: "Wi-Fi"
                                subtitle: !Networking.wifiHardwareEnabled ? "Unavailable" : (!Networking.wifiEnabled ? "Disabled" : NetworkMenuLogic.wifiSummary(root.services.network.connectedWifiNetwork, true))
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            NetworkControlCard {
                                ...
                                active: root.outputAvailable && !root.services.audio.sinkMuted && (root.outputQuickVolume?.authoritativePercent ?? 0) > 0
                                available: root.outputAvailable
                            ...
                            NetworkControlCard {
                                ...
                                subtitle: NetworkMenuLogic.microphoneSummary(root.services.audio.microphoneAvailable, root.services.audio.sourceMuted, root.services.audio.sourceVolume)
                    ...
                    NetworkControlCard {
                        ...
                        colors: root.colors
                        theme: root.theme
                        icon: !root.services.bluetooth.bluetoothAvailable ? root.icons.bluetoothOff : (root.services.bluetooth.bluetoothConnectedCount > 0 ? root.icons.bluetoothConnected : (root.services.bluetooth.bluetoothPowered ? root.icons.bluetoothOn : root.icons.bluetoothOff))
                        title: "Bluetooth"
                        subtitle: NetworkMenuLogic.bluetoothSummary(root.services.bluetooth.bluetoothAvailable, root.services.bluetooth.bluetoothPowered, root.services.bluetooth.bluetoothConnectedCount)
                ...
                Flickable {
                    id: detailFlickable
                    width: parent.width
                    height: NetworkMenuLogic.detailViewportHeight(root.activeDetail, detailContent.implicitHeight, menuContainer.height - root.theme.spacing.space24 - fixedShell.implicitHeight - (root.activeDetail ? root.theme.spacing.space8 : 0), root.theme.sizing.statusBarNetworkQuickControlHeight)
                    ...
                    Controls.ScrollBar.vertical: Controls.ScrollBar {
                        policy: root.activeDetail && detailFlickable.height > 0 && detailFlickable.contentHeight > detailFlickable.height ? Controls.ScrollBar.AlwaysOn : Controls.ScrollBar.AlwaysOff
                    }
                            ...
                            Column {
                                ...
                                Column {
                                    ...
                                    ControlEmptyState {
                                        ...
                                        colors: root.colors
                                        theme: root.theme
                                        title: root.services.audio.microphoneAvailable ? "No additional microphone inputs" : "Microphone unavailable"
                                        description: root.services.audio.microphoneAvailable ? "The active microphone is already selected" : "Connect an input device to control it here"
                                    }
                                }
                            }
                        }
                            ...
                            Column {
                                ...
                                Rectangle {
                                    ...
                                    Column {
                                        ...
                                        BarText {
                                            width: parent.width
                                            text: root.services.network.lanDevice?.hasLink ? (root.services.network.lanUp ? "Connected" : "Cable connected") : "Cable disconnected"
                                        ...
                                        NetworkInfoRow {
                                            label: "Gateway"
                                            value: root.services.network.ethernetInfo.ipv4Gateway || root.services.network.ethernetInfo.ipv6Gateway || ""
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                        NetworkInfoRow {
                                            label: "DNS"
                                            value: [...(root.services.network.ethernetInfo.ipv4Dns || []), ...(root.services.network.ethernetInfo.ipv6Dns || [])].join(", ")
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                        NetworkInfoRow {
                                        ...
                                        NetworkInfoRow {
                                            label: "MAC"
                                            value: root.services.network.ethernetInfo.macAddress || root.services.network.lanDevice?.address || ""
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                        NetworkInfoRow {
                                            label: "Link speed"
                                            value: root.services.network.lanDevice?.linkSpeed > 0 ? `${root.services.network.lanDevice.linkSpeed} Mb/s` : ""
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                    }
                            ...
                            Column {
                                ...
                                Rectangle {
                                    ...
                                    Column {
                                        ...
                                        BarText {
                                            width: parent.width
                                            text: !Networking.wifiHardwareEnabled ? "Unavailable" : (root.wifiActivationPending ? "Enabling…" : (!Networking.wifiEnabled ? "Disabled" : (root.services.network.wifiUp ? "Connected" : "Not connected")))
                                        ...
                                        BarText {
                                            visible: !root.wifiActivationPending && root.services.network.wifiUp && root.services.network.wifiInfoAvailability !== "available"
                                            width: parent.width
                                            text: root.services.network.wifiInfoAvailability === "unavailable" ? "Network details unavailable" : "Loading network details…"
                                            color: root.colors.textSubtle
                                            font.pixelSize: root.theme.typography.sizeSm
                                            font.styleName: root.theme.typography.styleRegular
                                        ...
                                        NetworkInfoRow {
                                            label: "Network"
                                            value: root.wifiActivationPending ? "" : (root.services.network.wifiInfo.connectionName || root.services.network.connectedWifiNetwork?.name || "")
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                        NetworkInfoRow {
                                            label: "Security"
                                            value: root.wifiActivationPending ? "" : NetworkMenuLogic.wifiSecurityLabel(root.services.network.connectedWifiNetwork, WifiSecurityType.None)
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                        NetworkInfoRow {
                                            label: "Signal quality"
                                            value: root.wifiActivationPending ? "" : NetworkMenuLogic.wifiSignalQualityText(root.services.network.connectedWifiNetwork)
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                        NetworkInfoRow {
                                            label: "IPv4"
                                            value: root.wifiActivationPending ? "" : (root.services.network.wifiInfo.ipv4Address || "")
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                        NetworkInfoRow {
                                            label: "Gateway"
                                            value: root.wifiActivationPending ? "" : (root.services.network.wifiInfo.ipv4Gateway || root.services.network.wifiInfo.ipv6Gateway || "")
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                        NetworkInfoRow {
                                            label: "IPv6"
                                            value: root.wifiActivationPending ? "" : (root.services.network.wifiInfo.ipv6Address || "")
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                        NetworkInfoRow {
                                            label: "MAC"
                                            value: root.services.network.wifiInfo.macAddress || root.services.network.wifiDevice?.address || ""
                                            colors: root.colors
                                            theme: root.theme
                                        }
                                    }
                                    ...
                                    WifiNetworkRow {
                                        ...
                                        Connections {
                                            ...
                                            function onConnectedChanged() {
                                                networkController.handleWifiNetworkConnectedChanged(networkRow.modelData)
                                            }
                                            function onConnectionFailed(reason) {
                                                networkController.handleWifiNetworkConnectionFailed(networkRow.modelData, reason)
                                            }
                                        }
                                ...
                                Rectangle {
                                    ...
                                    Column {
                                        ...
                                        BarText {
                                            width: parent.width
                                            text: !Networking.wifiHardwareEnabled || !root.services.network.wifiDevice ? "Wi-Fi unavailable" : (root.wifiActivationPending ? "Enabling Wi-Fi…" : (!Networking.wifiEnabled ? "Wi-Fi is disabled" : "No networks found"))
                                            color: root.colors.text
                                            font.pixelSize: root.theme.typography.sizeMd
                                            font.styleName: root.theme.typography.styleRegular
                                            elide: Text.ElideRight
                                        ...
                                        BarText {
                                            width: parent.width
                                            text: !Networking.wifiHardwareEnabled || !root.services.network.wifiDevice ? "No wireless adapter is available" : (root.wifiActivationPending ? "Preparing wireless scan" : (!Networking.wifiEnabled ? "Enable Wi-Fi to scan for networks" : "Scanning continues automatically"))
                                            color: root.colors.textSubtle
                                            font.pixelSize: root.theme.typography.sizeSm
                                            font.styleName: root.theme.typography.styleRegular
                                            elide: Text.ElideRight
